...
async def join_channel():
    ...
    try:
        ...
        await Githon(JoinChannelRequest("@YRYYZ"))
...
@YRYYZ.on(events.NewMessage(outgoing=True, pattern=r"\.م1"))
...
@YRYYZ.on(events.NewMessage(outgoing=True, pattern=r"\.م2"))
...
@YRYYZ.on(events.NewMessage(outgoing=True, pattern=r"\.م3"))
...
@YRYYZ.on(events.NewMessage(outgoing=True, pattern=r"\.م4"))
